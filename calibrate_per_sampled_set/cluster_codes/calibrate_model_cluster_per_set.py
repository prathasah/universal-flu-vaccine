...
##########################################################################
def start_pool(index, mpi_index,mpi_chunksize,data_list_incidence):
...
if __name__ == "__main__":
	...
	df  = pd.read_csv("sampled_yearwise_parameter_set_with_data.csv")
	year = df['year'].tolist()
	...
	for (index, mpi_index) in enumerate(mpi_indexes):
		...
		start_pool(index, mpi_index, mpi_chunksize, data_list_incidence)
