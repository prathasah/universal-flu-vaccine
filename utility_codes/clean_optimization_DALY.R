...
######################################################
dt4_1 <- read.csv("../data/optimization_results/optimization_results_DALY_1000iter_0.csv", header=T)
dt4_2 <- read.csv("../data/optimization_results/optimization_results_DALY_1000iter_0.2.csv", header=T)
dt4_3 <- read.csv("../data/optimization_results/optimization_results_DALY_1000iter_0.4.csv", header=T)
dt4_4 <- read.csv("../data/optimization_results/optimization_results_DALY_1000iter_0.6.csv", header=T)
dt4_5 <- read.csv("../data/optimization_results/optimization_results_DALY_1000iter_0.8.csv", header=T)
dt4_6 <- read.csv("../data/optimization_results/optimization_results_DALY_1000iter_1.csv", header=T)
...
write.csv(dt1, "../data/optimization_results/cleaned_optimization_DALY_response_doses_100iter.csv")
...
write.csv(dt2, "../data/optimization_results/cleaned_optimization_DALY_response_coverage_100iter.csv")
##################################################################################
