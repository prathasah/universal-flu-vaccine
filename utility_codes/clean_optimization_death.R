...
######################################################
dt3_1 <- read.csv("../data/optimization_results/optimization_results_deaths_1000iter_0.csv", header=T)
dt3_2 <- read.csv("../data/optimization_results/optimization_results_deaths_1000iter_0.2.csv", header=T)
dt3_3 <- read.csv("../data/optimization_results/optimization_results_deaths_1000iter_0.4.csv", header=T)
dt3_4 <- read.csv("../data/optimization_results/optimization_results_deaths_1000iter_0.6.csv", header=T)
dt3_5 <- read.csv("../data/optimization_results/optimization_results_deaths_1000iter_0.8.csv", header=T)
dt3_6 <- read.csv("../data/optimization_results/optimization_results_deaths_1000iter_1.csv", header=T)
...
#dt$scenario <- ifelse(dt$scenario=="0.low", "0.low",
#                       ifelse(dt$scenario=="medium", "1.medium", "2.high"))
...
write.csv(dt1, "../data/optimization_results/cleaned_optimization_death_response_doses_100iter.csv")
...
write.csv(dt2, "../data/optimization_results/cleaned_optimization_death_response_coverage_100iter.csv")