...
if __name__ == "__main__":
    ...
    for num in xrange(1000):
        ...
        high_risk_hosp_0 = numpy.random.uniform(6.0, 21.4) / numpy.random.uniform(0.57, 6.9)
        high_risk_hosp_20 = numpy.random.uniform(6.9, 22.3) / numpy.random.uniform(1.5, 12.0)
        high_risk_hosp_65 = numpy.random.uniform(33.3, 68.4) / numpy.random.uniform(12.5, 15.8)
        
        R0 = 1.222
        
        elements = [num, rec_rate,  prop_high_risk_0, prop_high_risk_2,prop_high_risk_5,prop_high_risk_19, prop_high_risk_25, prop_high_risk_50, prop_high_risk_65, susc_0, susc_5, susc_25, susc_50, susc_65, vac_eff_inf_0, vac_eff_inf_0_5, vac_eff_inf_16, vac_eff_inf_65, vac_eff_death_0, vac_eff_death_20, vac_eff_death_65, vac_eff_hosp_0, vac_eff_hosp_5, vac_eff_hosp_16, vac_eff_hosp_65, case_mort_0, case_mort_5, case_mort_18, case_mort_50, case_hosp_65, case_hosp_0, case_hosp_5, case_hosp_18, case_hosp_50, case_hosp_65, high_risk_mortality_0, high_risk_mortality_20, high_risk_mortality_65, high_risk_hosp_0, high_risk_hosp_20, high_risk_hosp_65, R0]
