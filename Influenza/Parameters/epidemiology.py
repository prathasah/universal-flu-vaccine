...
def HighRiskRelativeCaseMortalityPW(index):
    return PiecewiseAgeRate(
    [df.at[index, "highRiskRelativeCaseMortality_0"],
     df.at[index, "highRiskRelativeCaseMortality_20"],
     df.at[index, "highRiskRelativeCaseMortality_65"]],
    [0, 20, 65])
...
def HighRiskRelativeCaseHospitalizationPW(index):
    return PiecewiseAgeRate(
    [df.at[index, "highRiskRelativeCaseHosp_0"],
     df.at[index, "highRiskRelativeCaseHosp_20"],
     df.at[index, "highRiskRelativeCaseHosp_65"]],
    [0, 20, 65])
