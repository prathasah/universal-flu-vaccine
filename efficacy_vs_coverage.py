...
def run_efficacy_simulation(vacEfficacy, vacDoses, vaccination_type, sub_iter):
	...
	cal_incidenceL, cal_incidenceH, infections_H1, infections_H3, infections_B, perc_H1, perc_H3, perc_B = s.calibration_output()
	prop_vax_TL, prop_vax_TH, prop_vax_NL, prop_vax_NH, doses_TL, doses_TH, doses_NL, doses_NH = s.vaccinated_output()
	return infectionsL, infectionsH, hospitalizationsL, hospitalizationsH,mortalityL, mortalityH, prop_vax_TL, prop_vax_TH, prop_vax_NL, prop_vax_NL, prop_vax_NH, doses_TL, doses_TH, doses_NL, doses_NH, cal_incidenceL, cal_incidenceH
...
if __name__ == "__main__":
	...
	for sub_index in xrange(10):
		...
		infectionsL, infectionsH, hospitalizationsL, hospitalizationsH,mortalityL, mortalityH, prop_vax_TL, prop_vax_TH, prop_vax_NL, prop_vax_NL, prop_vax_NH, doses_TL, doses_TH, doses_NL, doses_NH, cal_incidenceL, cal_incidenceH = run_efficacy_simulation([0.48,0], doses, "typical", sub_index)
		...
		check_incidence.append(sum(cal_incidenceL))
		check_incidence.append(sum(cal_incidenceH))
	...
	print ("check incidence"), np.median(check_incidence)/1e6
